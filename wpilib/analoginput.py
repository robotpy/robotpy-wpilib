...
class AnalogInput(SensorBase):
    ...
    def getAverageValue(self):
        ...
        for this channel. The sample is 12-bit + the value configured in
        ...
        change until 2**(OversamplBits + AverageBits) samples have been
        ...
        if not self.isAccumulatorChannel():
            raise IndexError(
                    ...
                    % (AnalogInput.kAccumulatorSlot,
                       ",".join(AnalogInput.kAccumulatorChannels)))
        self.accumulatorOffset = 0
