...
latex_documents = [
  ('index', 'RobotPyWPILib.tex', 'RobotPy WPILib Documentation',
...
texinfo_documents = [
  ('index', 'RobotPyWPILib', 'RobotPy WPILib Documentation',
   'RobotPy development team', 'RobotPyWPILib', 'One line description of project.',
   'Miscellaneous'),
]
